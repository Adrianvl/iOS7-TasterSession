//
//  SoCMSayingsTableViewController.m
//  Task-02
//
...
@interface SoCMSayingsTableViewController ()
- (IBAction)doSave:(id)sender;
@end

@implementation SoCMSayingsTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.sayingLabel.text = self.array[indexPath.row];
